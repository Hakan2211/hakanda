              ...
              <div className="w-full md:w-1/4 h-1/2 md:h-full flex flex-col bg-background/95 backdrop-blur border-l border-border/50">
                <div className="p-8 md:p-10 flex-1 overflow-y-auto">
                    ...
                    <div className="grid grid-cols-2 gap-6 mb-8">
                        <div>
                            <h3 className="text-xs font-semibold text-muted-foreground uppercase tracking-widest mb-2">Style</h3>
                             <Badge variant="outline" className="px-3 py-1 text-sm font-light tracking-wide border-primary/20 bg-primary/5">
                                {selectedItem.style}
                            </Badge>
                        </div>
                        <div>
                            <h3 className="text-xs font-semibold text-muted-foreground uppercase tracking-widest mb-2">Topic</h3>
                            <Badge variant="outline" className="px-3 py-1 text-sm font-light tracking-wide border-primary/20 bg-primary/5">
                                {selectedItem.topic}
                            </Badge>
                        </div>
                    ...
                    <div className="space-y-4 mb-8">
                        <h3 className="text-xs font-semibold text-muted-foreground uppercase tracking-widest">Prompt</h3>
                ...
                <div className="p-6 border-t border-border bg-muted/20">
                    <button 
                        onClick={() => {
                            const filename = `${selectedItem.title.replace(/\s+/g, '-').toLowerCase()}.jpg`;
                            const proxyUrl = `/api/download?url=${encodeURIComponent(selectedItem.url)}&filename=${filename}`;
