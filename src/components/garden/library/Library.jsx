          ...
          >
            <div className="flex flex-col md:flex-row gap-6 p-6 md:p-8">
              ...
              <div className="flex-1 flex flex-col justify-center">
                ...
                <p className="text-xl text-muted-foreground mb-4">{currentlyReading.author}</p>
                
                <div className="mb-4">
                  <Badge variant="default" className="px-3 py-1 bg-amber-500/20 text-amber-500 hover:bg-amber-500/30 border border-amber-500/50">
              ...
              <div className="w-full md:w-3/5 h-1/2 md:h-full flex flex-col bg-background/95 backdrop-blur border-l border-border/50">
                <div className="p-8 md:p-10 flex-1 overflow-y-auto">
                  ...
                  >
                    ...
                    <p className="text-xl text-muted-foreground">{selectedBook.author}</p>
                  </motion.div>

                  <div className="flex flex-wrap items-center gap-3 mb-6">
                    <Badge variant="default" className="px-3 py-1 text-xs uppercase tracking-wider bg-amber-500/20 text-amber-500 hover:bg-amber-500/30 border border-amber-500/50 shadow-[0_0_10px_rgba(245,158,11,0.2)]">
                      {selectedBook.category}
                    </Badge>
                    {selectedBook.status === 'reading' && (
                      <Badge variant="default" className="px-3 py-1 text-xs uppercase tracking-wider bg-green-500/20 text-green-500 hover:bg-green-500/30 border border-green-500/50">
                        Currently Reading
                      </Badge>
                    )}
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-6 mb-8">
                    <div>
                      ...
                      <Badge variant="outline" className="px-3 py-1 text-sm font-light tracking-wide border-primary/20 bg-primary/5">
                        {selectedBook.status === 'reading' ? 'In Progress' : 'Completed'}
                      </Badge>
                    </div>
                    <div>
                      <h3 className="text-xs font-semibold text-muted-foreground uppercase tracking-widest mb-2">Year</h3>
                      <Badge variant="outline" className="px-3 py-1 text-sm font-light tracking-wide border-primary/20 bg-primary/5">
                  ...
                  <div className="space-y-6 mb-8">
                    ...
                    {selectedBook.notes && (
                      <div>
                        <h3 className="text-xs font-semibold text-muted-foreground uppercase tracking-widest mb-3">My Notes</h3>
