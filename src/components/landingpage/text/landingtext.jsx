...
float perlinClassic3D(vec3 P)
{
  ...
  void main() {
    vUv = uv;
    vColor = mix(colorA, colorB, perlinClassic3D(vec3(position.z,position.x, position.y ) * 1.0));
...
const MyShaderMaterial = new THREE.ShaderMaterial({
  ...
  fragmentShader,
  uniforms: {
    colorA: { value: new THREE.Color(0xf5e3a3) },
    colorB: { value: new THREE.Color(0xa58512) },
    // colorA: { value: new THREE.Color(0xbfdbfe) },
    // colorB: { value: new THREE.Color(0xfecaca) },
  },
});
