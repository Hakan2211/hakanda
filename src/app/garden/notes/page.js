    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      <header className="mb-12">
        ...
        <p className="text-muted-foreground text-lg">
          Seeds of ideas and quick learnings. Snapshots that are too brief for
          full articles but worth planting here. Some might grow into detailed
          blog posts with interactive components down the road.
        </p>
      </header>
